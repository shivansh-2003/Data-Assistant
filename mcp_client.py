...
# Configuration
MCP_SERVER_URL = os.getenv("MCP_SERVER_URL", "https://data-assistant-84sf.onrender.com/data/mcp")
INGESTION_API_URL = os.getenv("INGESTION_API_URL", "https://data-assistant-84sf.onrender.com")
