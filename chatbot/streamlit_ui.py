...
from .session_loader import get_session_summary

logger = logging.getLogger(__name__)


def initialize_chatbot_state(session_id: str):
...
def render_chatbot_tab():
    ...
    initialize_chatbot_state(session_id)
    ...
    for msg in chat_history:
        ...
        display_chat_message(msg, is_user=is_user)
